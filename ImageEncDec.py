...
def encrypt_image(image, swap_pixels):
    if swap_pixels:
        # Swap pixel values between red and blue channels
        image_array = np.array(image)
        image_array[:, :, [0, 2]] = image_array[:, :, [2, 0]]
        return Image.fromarray(image_array)
    else:
        # Apply a basic mathematical operation to the image
...
def main():
    while True:
        # Load the image
        input_image_path = input("Enter the path of the image file (or type 'exit' to quit): ")
        ...
        while True:
            ...
            if choice == '1':
                # Ask the user to swap pixels or apply a basic mathematical operation
                ...
                # Ask the user whether to swap pixels or apply a basic mathematical operation
